const Privacy = () => {
    return (
        <div className="flex flex-col mx-[10vw] mt-5 sm:mx-[25vw]">
            ...
            <span className="text-stmp-main italic text-sm mt-5">
            ...
            <span className="text-neutral-400 text-sm mt-5 pb-5">
                ...
                <span className="text-white font-semibold">support@stmp.dev</span>
            </span>
            <div className="flex flex-col gap-4 text-[17px] pl-5">
                <li className="text-neutral-400 marker:text-stmp-main">Guild IDs</li>
                <li className="text-neutral-400 marker:text-stmp-main">Guild Names</li>
                <li className="text-neutral-400 marker:text-stmp-main">Channel IDs</li>
                <li className="text-neutral-400 marker:text-stmp-main">Role IDs</li>
                <li className="text-neutral-400 marker:text-stmp-main">User IDs</li>
                <li className="text-neutral-400 marker:text-stmp-main">Message Timestamps</li>
                <li className="text-neutral-400 marker:text-stmp-main">Message IDs</li>
                <li className="text-neutral-400 marker:text-stmp-main">Past Avatars</li>
                <li className="text-neutral-400 marker:text-stmp-main">Nicknames and Usernames</li>
                <li className="text-neutral-400 marker:text-stmp-main">
            ...
            <span className="text-neutral-400 text-sm mt-5">
                Email <span className="text-white font-semibold">support@stmp.dev</span> for all of
