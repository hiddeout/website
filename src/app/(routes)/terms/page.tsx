    ...
    return (
        <div className="flex flex-col mx-[10vw] mt-5 sm:mx-[25vw]">
            ...
            <span className="text-neutral-400 text-sm mt-5 pb-5">
                By visiting (&apos;stmp&apos;) or inviting (&apos;stmp Bot&apos;) to your Discord
                or logging into our website (&apos;stmp.dev&apos;), you agree and consent to the
                terms displayed on this page including our policies (Privacy Policy). When we state
                &apos;stmp&apos;, &apos;we&apos;, &apos;us&apos;, and &apos;our&apos; in these
                terms, we mean stmp. &apos;Services&apos; mean stmp&apos;s services that we offer
                to users.
            </span>
            ...
            <span className="text-neutral-400 text-sm mt-5">
                You may not use stmp to violate any applicable laws or regulations as well as
                ...
                <span className="text-white font-semibold">support@stmp.dev</span>. If you are
                refunded under any circumstances, your Discord account may be subject to blacklist
                and a ban from all of our services.
            </span>
            <span className="font-bold text-2xl text-white pt-10">stmp Website Usage</span>
            <span className="text-neutral-400 text-sm mt-5">
            ...
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                ...
                <li className="text-neutral-400 marker:text-stmp-main">
                    Copy stmp&apos;s website and claiming it as your own work
                </li>
            </div>
            <span className="font-bold text-2xl text-white pt-10">stmp Bot Usage</span>
            <span className="text-neutral-400 text-sm mt-5">
            ...
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                ...
                <li className="text-neutral-400 marker:text-stmp-main">
                    Copy stmp&apos;s services or features
                </li>
                <li className="text-neutral-400 marker:text-stmp-main">
                    Assist anyone in copying stmp&apos;s services or features
                </li>
                <li className="text-neutral-400 marker:text-stmp-main">
                    Abuse or exploit stmp or any of our services.
                </li>
                <li className="text-neutral-400 marker:text-stmp-main">
